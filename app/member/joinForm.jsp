...
<html>
	<head>
		<title>Treat Trip::Join Us!</title>
		<meta charset="utf-8" />
	...
	<body class=""  onresize="parent.resizeTo(600,700)" onload="parent.resizeTo(600,700)">
		<!-- Banner -->
			<section id="banner" style="margin-top:-5em">
				<h2>JOIN US</h2>
				
				<form method="post" action="${pageContext.request.contextPath}/member/MemberJoinOk.me" name="joinForm">
				
					<div class="row gtr-uniform gtr-50" id="joinFrm" >
						<div class="col-12" >
							<input type="text" name="member_id" id="member_id" placeholder="아이디" >
							<a href="javascript:checkId(joinForm.member_id.value)" class="button small" >CHECK</a>
						</div> 
				
						<!-- id체크 text 넣을 div -->
						<div class="col-12 check" id="idCheck_text" ></div>
						...
						<!-- pw체크 text 넣을 div -->
						<div class="col-12 check" id="pwCheck_text">비밀번호는 8자 이상이어야 하며, 대문자/소문자/숫자/특수문자 모두 포함해야 합니다.</div>
						...
						<div class="col-12" >
							...
							<a href="javascript:checkEmail(joinForm.member_email.value)" class="button small" >CHECK</a>
						</div> 
				
						<!-- id체크 text 넣을 div -->
						<div class="col-12 check" id="emailCheck_text" ></div>

						<div class="col-12"><textarea name="agree" id="agree" rows="8" style="resize: none; color: white; font-size: 0.8em; readonly">
									시행일자 : 2020년 08월 28일

제1조 (목적)
본 약관은 트릿트립 주식회사(이하 '회사')가 고도 사이트(이하 ‘사이트’)를 통하여 인터넷상에서 제공하는 서비스(이하 ‘서비스’)를 이용하는 고객 (이하 '고객')간의 권리와 의무 및 책임 등 기타 제반사항을 규정함을 목적으로 합니다.
...
본 약관은 2020년 8월 28일부터 적용하고, 2016년 5월 2일부터 시행되던 종전의 약관은 본 약관으로 대체합니다.
								...
								<!-- 약관 동의 체크 부 -->
								<div class="col-12" style="width: 70%; margin-top:0.5em; margin-left:auto; margin-right:auto;">
									<input type="checkbox" id="agree-check" name="agree-check" style="margin-left: 33%;" >
									<label for="agree-check" style="font-weight: bold"><span style="color: red;">[필수]</span> 약관 및 개인정보 수집/이용 동의</label>
								</div>

						<div class="col-12">
							<input type="submit" value="Send" class="primary" id="joinFrmSend" disabled="disabled" onclick="return sendJoin();">
						</div>
				</form>
